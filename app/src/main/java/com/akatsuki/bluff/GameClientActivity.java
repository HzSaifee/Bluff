...
public class GameClientActivity extends Activity {
                    ...
                    case 3:
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Toast.makeText(getApplicationContext(), "cards played", Toast.LENGTH_SHORT).show();
                            }
                        });
                        break;
                    case 4:
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(getApplicationContext(), "Chance of player: " + chance, Toast.LENGTH_SHORT).show();
                                setImage(5);
                                textView.setText(R.string.kya_bolta_h);
                            }
                        });
                        break;
                    case 5:
    ...
    private void setImage(int selectedLadke) {
        ...
        MediaPlayer mPlayer = MediaPlayer.create(getApplicationContext(), R.raw.flip);
    ...
    public void check(View view) {
        if (self.getPosition() == chance) {
            if (firstChance != chance) {
                ...
                Toast.makeText(getApplicationContext(), "Bhai Table khali hai", Toast.LENGTH_SHORT);
            }
        } else {
            Toast.makeText(getApplicationContext(), "Not your turn", Toast.LENGTH_SHORT).show();
        }
